...
<!--
This repo also runs automated secret scanning (gitleaks, see .gitleaks.toml and
lefthook.yml) and dependency update automation (renovate.json) as preventive
measures — see README > Recommended external tools.
-->
